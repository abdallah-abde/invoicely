...
export function InvoiceStatusBadge({ status }: { status: InvoiceStatus }) {
  const paidClr = `bg-[oklch(0.458_0.243_264.376)]`;

  const sentClr = `bg-[oklch(0.396_0.17_162.48)]`;

  const overdueClr = `bg-[oklch(0.469_0.188_70.08)]`;

  const draftClr = `bg-[oklch(0.427_0.265_303.9)]`;

  const canceledClr = `bg-[oklch(0.145_0.246_16.439)]`;

  const partialPaidClr = `bg-[oklch(0.572_0.205_149.54)]`;
